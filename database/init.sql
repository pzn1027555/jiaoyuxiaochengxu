/*
 ...
 Source Server         : 外网教育小程序
 Source Server Type    : MySQL
 Source Server Version : 80030 (8.0.30-txsql)
 Source Host           : nj-cdb-phxtkejx.sql.tencentcdb.com:28269
...
CREATE TABLE `community_comment_like`  (
  ...
  `comment_id` bigint NOT NULL COMMENT 'community_post_comment.id',
  ...
  UNIQUE INDEX `uk_comment_user`(`comment_id` ASC, `user_id` ASC, `user_type` ASC) USING BTREE,
...
CREATE TABLE `community_post`  (
  ...
  `status` int NOT NULL DEFAULT 1 COMMENT '状态：1-正常，2-下架，0-删除',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_author`(`author_id` ASC, `author_type` ASC) USING BTREE,
...
) ENGINE = InnoDB AUTO_INCREMENT = 26 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '社区帖子表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `community_post_comment`  (
  ...
  `parent_id` bigint NULL DEFAULT NULL COMMENT '父评论ID，可为空',
  `user_id` bigint NOT NULL,
  `user_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT 'student/parent/teacher',
...
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '帖子评论' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `community_post_like`  (
  ...
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_post_user`(`post_id` ASC, `user_id` ASC, `user_type` ASC) USING BTREE,
  INDEX `idx_post_id`(`post_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 46 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '帖子点赞明细' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `community_resource`  (
  ...
  `publisher_user_id` bigint NULL DEFAULT NULL COMMENT '发布管理员(sys_user.id)',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_status`(`status` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '社区-资源下载区' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `complaint_record`  (
  ...
  `related_order_id` bigint NULL DEFAULT NULL COMMENT '相关订单ID',
  `related_course_id` bigint NULL DEFAULT NULL COMMENT '相关课程ID',
  `complaint_status` int NOT NULL DEFAULT 0 COMMENT '投诉状态：0-待处理，1-处理中，2-已解决，3-已关闭',
  ...
  `satisfaction_score` int NULL DEFAULT NULL COMMENT '满意度评分：1-5分',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_complaint_no`(`complaint_no` ASC) USING BTREE,
  INDEX `idx_complainant`(`complainant_id` ASC, `complainant_type` ASC) USING BTREE,
  INDEX `idx_complained`(`complained_id` ASC, `complained_type` ASC) USING BTREE,
...
CREATE TABLE `course_banner`  (
  ...
  `sort_order` int NOT NULL DEFAULT 0 COMMENT '排序(越大越前)',
  `is_enabled` tinyint(1) NOT NULL DEFAULT 1 COMMENT '是否启用：1-启用 0-禁用',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '课程页轮播图' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `course_category`  (
  ...
  `parent_id` bigint NULL DEFAULT NULL COMMENT '父级分类ID，NULL表示一级分类',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1354 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '课程类别表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `employment_application`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `post_id` bigint NOT NULL COMMENT 'employment_post.id',
  `teacher_id` bigint NULL DEFAULT NULL COMMENT '申请教师ID（可空，未登录时）',
  ...
  `resume_size` bigint NULL DEFAULT NULL COMMENT '简历文件大小(字节)',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_post_id`(`post_id` ASC) USING BTREE,
...
CREATE TABLE `financial_settlement`  (
  ...
  `settlement_status` int NULL DEFAULT 0 COMMENT '结算状态：0-待结算，1-已结算，2-已打款',
  ...
  INDEX `idx_settlement_period`(`start_date` ASC, `end_date` ASC) USING BTREE
...
CREATE TABLE `invitation_record`  (
  ...
  `reward_status` int NULL DEFAULT 0 COMMENT '奖励状态：0-未发放，1-已发放，2-已取消',
  `reward_time` datetime NULL DEFAULT NULL COMMENT '奖励发放时间',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_invitation_code`(`invitation_code` ASC) USING BTREE,
  INDEX `idx_activity_id`(`activity_id` ASC) USING BTREE,
  INDEX `idx_inviter`(`inviter_id` ASC, `inviter_type` ASC) USING BTREE,
  INDEX `idx_invited`(`invited_id` ASC, `invited_type` ASC) USING BTREE,
...
CREATE TABLE `learning_system_config`  (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_system_key`(`system_key` ASC) USING BTREE,
  INDEX `idx_enabled`(`is_enabled` ASC) USING BTREE,
  INDEX `idx_sort`(`sort_order` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '学习体系配置' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `lesson_price_config`  (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '统一课时价格配置(仅一条记录生效)' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `miniprogram_login_log`  (
  ...
  `user_id` bigint NOT NULL COMMENT '用户ID（对应各自表的ID）',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_user_type_id`(`user_type` ASC, `user_id` ASC) USING BTREE,
...
CREATE TABLE `miniprogram_user`  (
  ...
  `user_type` int NULL DEFAULT 0 COMMENT '用户类型：0-未知，1-学生，2-家长，3-教师',
...
) ENGINE = InnoDB AUTO_INCREMENT = 62 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '小程序用户表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `mooc_application`  (
  ...
  `group_id` bigint NULL DEFAULT NULL COMMENT '分配的小组ID',
  ...
  INDEX `idx_teacher_id`(`teacher_id` ASC) USING BTREE,
  INDEX `idx_status`(`status` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '磨课申请表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `mooc_group`  (
  ...
  `creator_user_id` bigint NULL DEFAULT NULL COMMENT '创建人',
...
CREATE TABLE `mooc_notification`  (
  ...
  `teacher_id` bigint NOT NULL COMMENT '接收教师ID',
  ...
  `related_id` bigint NULL DEFAULT NULL COMMENT '关联ID（如group_id或application_id）',
  `is_read` tinyint(1) NOT NULL DEFAULT 0 COMMENT '是否已读：0-未读，1-已读',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_teacher_time`(`teacher_id` ASC, `create_time` ASC) USING BTREE,
  INDEX `idx_type`(`type` ASC) USING BTREE,
  INDEX `idx_is_read`(`is_read` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '磨课通知表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `order_info`  (
  ...
  `schedule_id` bigint NULL DEFAULT NULL COMMENT '排课ID（可空，试听代付/尚未选课时为空）',
  ...
  `order_status` int NOT NULL DEFAULT 1 COMMENT '订单状态：1-待支付，2-已支付，3-已完成，4-已取消，5-已退款，6-售后中',
  `payment_status` int NULL DEFAULT 0 COMMENT '支付状态：0-未支付，1-已支付，2-部分退款，3-全额退款',
  ...
  `survey_id` bigint NULL DEFAULT NULL COMMENT '关联的预约调查ID（student_survey表）',
...
) ENGINE = InnoDB AUTO_INCREMENT = 36 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '订单信息表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `order_refund`  (
  ...
  INDEX `idx_status`(`status` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '订单售后(退款)表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `order_review`  (
  ...
  `order_id` bigint NOT NULL COMMENT '订单ID（order_info.id）',
  `student_id` bigint NOT NULL COMMENT '学生ID（student_info.id）',
  `teacher_id` bigint NOT NULL COMMENT '教师ID（teacher_info.id）',
  `star_rating` int NOT NULL COMMENT '星级评分：1-5分',
  ...
  `status` int NOT NULL DEFAULT 1 COMMENT '状态：1-正常，0-隐藏',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_student_order`(`student_id` ASC, `order_id` ASC) USING BTREE,
  INDEX `idx_order_id`(`order_id` ASC) USING BTREE,
  INDEX `idx_teacher_id`(`teacher_id` ASC) USING BTREE,
  INDEX `idx_student_id`(`student_id` ASC) USING BTREE,
...
CREATE TABLE `parent_info`  (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_parent_no`(`parent_no` ASC) USING BTREE,
  UNIQUE INDEX `uk_parent_phone`(`phone` ASC) USING BTREE,
  UNIQUE INDEX `uk_parent_wx_openid`(`wx_openid` ASC) USING BTREE,
  INDEX `idx_parent_wx_unionid`(`wx_unionid` ASC) USING BTREE,
  INDEX `idx_parent_status`(`status` ASC) USING BTREE,
  INDEX `idx_parent_create_time`(`create_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 29 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '家长信息表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 19 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '家长-学生关联表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `parent_wallet`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `parent_id` bigint NOT NULL COMMENT 'parent_info.id',
  `balance` decimal(15, 2) NOT NULL DEFAULT 0.00 COMMENT '当前可用余额',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_parent`(`parent_id` ASC) USING BTREE,
  CONSTRAINT `fk_pw_parent` FOREIGN KEY (`parent_id`) REFERENCES `parent_info` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '家长钱包' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `parent_wallet_txn`  (
  ...
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_parent_time`(`parent_id` ASC, `create_time` ASC) USING BTREE,
  CONSTRAINT `fk_pwt_parent` FOREIGN KEY (`parent_id`) REFERENCES `parent_info` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '家长钱包流水' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `referral_activity`  (
  ...
  `invite_reward_course_id` bigint NULL DEFAULT NULL COMMENT '奖励课程ID',
  `invite_reward_coupon_id` bigint NULL DEFAULT NULL COMMENT '奖励优惠券ID',
  ...
  `max_invite_count` int NULL DEFAULT NULL COMMENT '最大邀请人数限制',
  ...
  `success_count` int NULL DEFAULT 0 COMMENT '成功邀请数',
  `total_reward_amount` decimal(15, 2) NULL DEFAULT 0.00 COMMENT '总奖励金额',
  `status` int NOT NULL DEFAULT 1 COMMENT '状态：1-进行中，2-已结束，0-已停止',
  ...
  INDEX `idx_status`(`status` ASC) USING BTREE,
  INDEX `idx_time_period`(`start_time` ASC, `end_time` ASC) USING BTREE
...
CREATE TABLE `research_application`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `post_id` bigint NOT NULL COMMENT 'research_post.id',
  `teacher_id` bigint NULL DEFAULT NULL COMMENT '报名教师ID',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_post_id`(`post_id` ASC) USING BTREE,
  INDEX `idx_teacher_id`(`teacher_id` ASC) USING BTREE
...
CREATE TABLE `sms_verification_code`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_phone_type`(`phone` ASC, `code_type` ASC) USING BTREE,
...
CREATE TABLE `student_head_teacher`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `student_id` bigint NOT NULL COMMENT '学生ID',
  `head_teacher_id` bigint NOT NULL COMMENT '班主任ID（head_teacher.id）',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '学生-班主任绑定关系' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `student_info`  (
  ...
  `referral_count` int NULL DEFAULT 0 COMMENT '推荐新学生数量',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_student_no`(`student_no` ASC) USING BTREE,
  UNIQUE INDEX `uk_student_wx_openid`(`wx_openid` ASC) USING BTREE,
  INDEX `idx_student_level`(`student_level` ASC) USING BTREE,
  INDEX `idx_province_city`(`province` ASC, `city` ASC) USING BTREE,
  INDEX `idx_last_course_time`(`last_course_time` ASC) USING BTREE,
  INDEX `idx_student_wx_unionid`(`wx_unionid` ASC) USING BTREE,
  INDEX `idx_student_phone`(`phone` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 34 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '学生信息表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `student_notification`  (
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_student_time`(`student_id` ASC, `create_time` ASC) USING BTREE,
  INDEX `idx_user_type`(`user_type` ASC) USING BTREE,
  INDEX `idx_type`(`type` ASC) USING BTREE,
  INDEX `idx_is_read`(`is_read` ASC) USING BTREE,
  CONSTRAINT `fk_sn_student` FOREIGN KEY (`student_id`) REFERENCES `student_info` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 32 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '学生通知表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `student_review`  (
  ...
  `student_id` bigint NOT NULL COMMENT '学生ID',
  `teacher_id` bigint NOT NULL COMMENT '教师ID',
  `schedule_id` bigint NULL DEFAULT NULL COMMENT '排课ID（teacher_schedule表）',
  ...
  `audit_status` int NOT NULL DEFAULT 1 COMMENT '审核状态：0-待审核，1-审核通过，2-审核拒绝',
  `audit_reason` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '审核原因',
  `audit_time` datetime NULL DEFAULT NULL COMMENT '审核时间',
  `audit_user_id` bigint NULL DEFAULT NULL COMMENT '审核人ID',
  `like_count` int NULL DEFAULT 0 COMMENT '点赞数',
...
CREATE TABLE `student_survey`  (
  ...
  `status` int NULL DEFAULT 0 COMMENT '预约状态：0-待处理，1-已同意，2-已拒绝',
  `reject_reason` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '拒绝原因',
  `course_id` bigint NULL DEFAULT NULL COMMENT '选定课程ID（可选）',
  ...
  `detail_id` bigint NULL DEFAULT NULL COMMENT '问卷明细ID（student_survey_detail.id）',
  PRIMARY KEY (`id`) USING BTREE,
  ...
  INDEX `idx_booking_type`(`booking_type` ASC) USING BTREE,
  INDEX `idx_paid`(`paid` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '学生调查问卷' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `student_survey_detail`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `teacher_id` bigint NULL DEFAULT NULL COMMENT '教师ID（冗余写入，便于运营侧检索）',
  `student_id` bigint NULL DEFAULT NULL COMMENT '学生ID（冗余写入）',
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '学生问卷明细' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `student_teacher_favorite`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_student_teacher`(`student_id` ASC, `teacher_id` ASC) USING BTREE,
  INDEX `idx_teacher`(`teacher_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '学生收藏老师' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `study_plan`  (
  ...
  `duration_minutes` int NULL DEFAULT 120 COMMENT '单节时长(分钟)',
  ...
  INDEX `idx_teacher_student`(`teacher_id` ASC, `student_id` ASC) USING BTREE,
  INDEX `idx_order_id`(`order_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '学习计划表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for subject_lesson_price
-- ----------------------------
DROP TABLE IF EXISTS `subject_lesson_price`;
CREATE TABLE `subject_lesson_price`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `subject_id` bigint NOT NULL COMMENT '学科ID（关联course_category.id）',
  `subject_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '学科名称（冗余字段，便于显示）',
  `price` decimal(10, 2) NOT NULL COMMENT '课时价格(元/课时)',
  `currency` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'CNY' COMMENT '币种',
  `is_enabled` tinyint(1) NOT NULL DEFAULT 1 COMMENT '是否启用：1-启用，0-禁用',
  `remark` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_subject_id`(`subject_id` ASC) USING BTREE,
  INDEX `idx_enabled`(`is_enabled` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '学科课时价格配置表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `sys_menu`  (
  ...
  `menu_type` int NOT NULL DEFAULT 1 COMMENT '菜单类型：1-菜单，2-按钮',
...
CREATE TABLE `teacher_certification`  (
  ...
  `certification_status` int NOT NULL DEFAULT 0 COMMENT '认证状态：0-待审核，1-审核通过，2-审核拒绝，3-待面试，4-面试通过，5-面试不通过',
  ...
  `grade_user_id` bigint NULL DEFAULT NULL COMMENT '评级人ID',
...
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '教师认证表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `teacher_info`  (
  ...
  `teaching_experience` int NULL DEFAULT NULL COMMENT '教学经验（年）',
  `introduction` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '个人介绍',
  ...
  `audit_time` datetime NULL DEFAULT NULL COMMENT '审核时间',
  `audit_user_id` bigint NULL DEFAULT NULL COMMENT '审核人ID',
  `contract_status` int NULL DEFAULT 0 COMMENT '合同状态：0-未发送，1-已发送待签，2-已签署，3-已过期',
  ...
  `risk_level` int NULL DEFAULT 0 COMMENT '风险等级：0-正常，1-低风险，2-中风险，3-高风险',
  `complaint_count` int NULL DEFAULT 0 COMMENT '投诉次数',
  ...
  `total_students` int NULL DEFAULT 0 COMMENT '累计学生数',
  `total_courses` int NULL DEFAULT 0 COMMENT '累计课程数',
  `total_income` decimal(15, 2) NULL DEFAULT 0.00 COMMENT '累计收入',
  `star_rating` decimal(3, 1) NULL DEFAULT 5.0 COMMENT '学生评价星级',
  `check_count` int NULL DEFAULT 0 COMMENT '抽查次数',
  ...
  `teach_mode_preference` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT 'both' COMMENT '授课方式偏好：online-线上，offline-线下，both-线上线下都可',
  `recommend_order` int NULL DEFAULT 0 COMMENT '推荐排序',
  `status` int NOT NULL DEFAULT 1 COMMENT '状态：1-启用，0-禁用',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_teacher_no`(`teacher_no` ASC) USING BTREE,
  UNIQUE INDEX `uk_teacher_wx_openid`(`wx_openid` ASC) USING BTREE,
  INDEX `idx_audit_status`(`audit_status` ASC) USING BTREE,
  INDEX `idx_contract_status`(`contract_status` ASC) USING BTREE,
  INDEX `idx_teacher_level`(`teacher_level` ASC) USING BTREE,
  INDEX `idx_risk_level`(`risk_level` ASC) USING BTREE,
  INDEX `idx_is_hidden`(`is_hidden` ASC) USING BTREE,
  INDEX `idx_is_recommended`(`is_recommended` ASC) USING BTREE,
  INDEX `idx_star_rating`(`star_rating` ASC) USING BTREE,
  INDEX `idx_status`(`status` ASC) USING BTREE,
  INDEX `idx_teacher_wx_unionid`(`wx_unionid` ASC) USING BTREE,
  INDEX `idx_teacher_phone`(`phone` ASC) USING BTREE,
  INDEX `idx_province_city`(`province` ASC, `city` ASC) USING BTREE,
  INDEX `idx_teach_mode`(`teach_mode_preference` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 38 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '教师信息表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `teacher_level_config`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_level_key`(`level_key` ASC) USING BTREE,
  INDEX `idx_enabled`(`is_enabled` ASC) USING BTREE
...
CREATE TABLE `teacher_notification`  (
  ...
  `certification_id` bigint NULL DEFAULT NULL COMMENT '关联的认证ID',
  ...
  INDEX `idx_is_read`(`is_read` ASC) USING BTREE,
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 15 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '教师通知表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `teacher_recommend`  (
  ...
  `order_count` int NULL DEFAULT 0 COMMENT '产生订单数',
  `status` int NOT NULL DEFAULT 1 COMMENT '状态：1-启用，0-禁用',
  `create_user_id` bigint NULL DEFAULT NULL COMMENT '创建人ID',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  ...
  INDEX `idx_recommend_order`(`recommend_order` ASC) USING BTREE,
  INDEX `idx_status`(`status` ASC) USING BTREE,
  INDEX `idx_time_period`(`start_time` ASC, `end_time` ASC) USING BTREE
...
CREATE TABLE `teacher_resource`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `teacher_id` bigint NOT NULL COMMENT '教师ID，关联 teacher_info.id',
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_teacher_type`(`teacher_id` ASC, `type` ASC) USING BTREE,
  INDEX `idx_published`(`is_published` ASC) USING BTREE,
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '教师资源：试听视频/学习资料/证书' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `teacher_schedule`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `teacher_id` bigint NOT NULL COMMENT '教师ID',
  `course_id` bigint NULL DEFAULT NULL COMMENT '课程ID，可为空',
  `subject_id` bigint NULL DEFAULT NULL COMMENT '科目分类ID（关联course_category.id）',
  ...
  `total_lessons` int NULL DEFAULT NULL,
  ...
  `duration_minutes` int NULL DEFAULT 90,
  ...
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `lesson_number` int NULL DEFAULT 1 COMMENT '第几节课\r\n',
  ...
  `confirmation_status` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'unconfirmed' COMMENT '确认状态：unconfirmed-未确认，confirmed-已确认付款',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_teacher_time`(`teacher_id` ASC, `start_time` ASC) USING BTREE,
  INDEX `idx_subject_id`(`subject_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 108 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '教师日程排课' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `teacher_schedule_feedback`  (
  ...
  `star_rating` int NULL DEFAULT 5 COMMENT '星级(1-5)',
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `feedback_type` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '教师反馈类型：teacher_daily(课堂反馈)/midterm(中期报告)',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_schedule_role`(`schedule_id` ASC, `role_type` ASC) USING BTREE,
  INDEX `idx_teacher`(`teacher_id` ASC) USING BTREE,
  INDEX `idx_student`(`student_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '教师单节课反馈' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `teacher_schedule_student`  (
  ...
  `student_id` bigint NOT NULL COMMENT '学生ID',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_schedule_student`(`schedule_id` ASC, `student_id` ASC) USING BTREE,
  INDEX `idx_schedule_id`(`schedule_id` ASC) USING BTREE,
  INDEX `fk_tss_student`(`student_id` ASC) USING BTREE,
...
) ENGINE = InnoDB AUTO_INCREMENT = 159 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '排课-学生关联' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `user_badge_notification`  (
  ...
  `badge_count` int NOT NULL DEFAULT 0 COMMENT '红点数量（0表示只显示红点不显示数字）',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_user_badge`(`user_id` ASC, `user_type` ASC, `badge_key` ASC) USING BTREE,
  INDEX `idx_user_type`(`user_id` ASC, `user_type` ASC) USING BTREE,
  INDEX `idx_badge_key`(`badge_key` ASC) USING BTREE,
  INDEX `idx_is_visible`(`is_visible` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户红点通知管理表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `user_invite_code`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `user_id` bigint NOT NULL COMMENT '用户ID（学生/家长/教师）',
  ...
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_user_type`(`user_id` ASC, `user_type` ASC, `code_type` ASC) USING BTREE,
  UNIQUE INDEX `uk_code`(`code` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 25 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户固定邀请码/绑定码' ROW_FORMAT = DYNAMIC;

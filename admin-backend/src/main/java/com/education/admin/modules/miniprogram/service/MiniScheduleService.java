...
public interface MiniScheduleService {
    Result<Object> getDaySchedule(String date); // yyyy-MM-dd
    ...
    Result<Object> submitFeedback(Long scheduleId, String content);

    Result<Object> getMonthSchedule(String month);
}
